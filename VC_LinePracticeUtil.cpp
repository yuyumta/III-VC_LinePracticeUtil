        ...
        Events::processScriptsEvent += [] {
            ...
            if (KeyPressed(0x31) && (CTimer::m_snTimeInMilliseconds > (m_nLastSpawnedTime + 1000)) && (player->m_bInVehicle)) {
                ...
                if (!vposition.x) {
                    ...
                    ux = vehicle->m_placement.up.x;
                    uy = vehicle->m_placement.up.y;
                    uz = vehicle->m_placement.up.z;
                    rx = vehicle->m_placement.right.x;
                    ry = vehicle->m_placement.right.y;
                    rz = vehicle->m_placement.right.z;
                ...
                */
                ...
                vehicle->m_placement.up.x = ux;
                vehicle->m_placement.up.y = uy;
                vehicle->m_placement.up.z = uz;
                vehicle->m_placement.right.x = rx;
                vehicle->m_placement.right.y = ry;
                vehicle->m_placement.right.z = rz;
                ...
                CHud::SetHelpMessage(weird_string, true, false);
            ...
            if (KeyPressed(0x32) && (CTimer::m_snTimeInMilliseconds > (m_nLastSpawnedTime + 1000)) && (!player->m_bInVehicle)) {
                ...
                TheCamera.Cams->Beta = ch;
                TheCamera.Cams->Alpha = cv;
            ...
            if (KeyPressed(VK_TAB) && (CTimer::m_snTimeInMilliseconds > (m_nLastSpawnedTime + 1000))) {
                ...
                if (!player->m_bInVehicle) {
                    ...
                    ch = TheCamera.Cams->Beta;
                    cv = TheCamera.Cams->Alpha;
